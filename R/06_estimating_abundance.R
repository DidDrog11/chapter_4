...
praomys_rostratus <- produce_abundance(species_name = included_species[3], k = 180)
mus_musculus <- produce_abundance(species_name = included_species[4], k = 180)
rattus_rattus <- produce_abundance(species_name = included_species[5], k = 90)
lophuromys_sikapusi <- produce_abundance(species_name = included_species[6], k = 60)
mus_setulosus <- produce_abundance(species_name = included_species[7], k = 50)
crocidura_buettikoferi <- produce_abundance(species_name = included_species[8], k = 40)
crocidura_grandiceps <- produce_abundance(species_name = included_species[9], k = 40)
...
plot_abundance(species = crocidura_olivieri, fig_label = "B", label_y_position = 100, label_x_shift = 5)
plot_abundance(species = praomys_rostratus, fig_label = "C", label_y_position = 250, label_x_shift = 15)
plot_abundance(species = mus_musculus, fig_label = "D", label_y_position = 250, label_x_shift = 10)
plot_abundance(species = rattus_rattus, fig_label = "E", label_y_position = 200, label_x_shift = 5)
plot_abundance(species = lophuromys_sikapusi, fig_label = "F", label_y_position = 250, label_x_shift = 5)
plot_abundance(species = mus_setulosus, fig_label = "G", label_y_position = 250, label_x_shift = 5)
plot_abundance(species = crocidura_buettikoferi, fig_label = "H", label_y_position = 250, label_x_shift = 5)
plot_abundance(species = crocidura_grandiceps, fig_label = "I", label_y_position = 250, label_x_shift = 5)
plot_abundance(species = malacomys_edwardsi, fig_label = "J", label_y_position = 250, label_x_shift = 2)
plot_abundance(species = lemniscomys_striatus, fig_label = "K", label_y_position = 250, label_x_shift = 2)
plot_abundance(species = other, fig_label = "L", label_y_position = 250, label_x_shift = 2)
